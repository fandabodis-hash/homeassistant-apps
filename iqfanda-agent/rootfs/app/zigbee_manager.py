...
# ==========================================================
# PHASE25_INFRASTRUCTURE_NATIVE_PERMIT_0198
# ==========================================================


def open_zigbee_infrastructure_native_permit(
    duration_seconds: int = 180,
) -> dict[str, Any]:
    """
    Otevre permit join pouze pro infrastrukturni pairing.

    Pouziva nativni Home Assistant ZHA WebSocket prikaz
    zha/devices/permit, stejny mechanismus jako nativni
    obrazovka Home Assistant "Pridat zarizeni".

    Tato funkce se nesmi pouzivat pro technologicke moduly.
    """
    ...
    try:
        ...
        raise ValueError(
            "Delka infrastrukturniho Zigbee "
            "parovani musi byt cele cislo."
        ) from exc
